              ...
              Expanded(
                  child: Padding(
                      ...
                      child: ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount: RemindersList.allReminders.length,
                          itemBuilder: (context, index) {
                            return Container(
                              ...
                              Container(
                                ...
                                color: (RemindersList.allReminders[index]
                                            ['priority'] ==
                                        'High'
                                    ? Colors.red
                                    : (RemindersList.allReminders[index]
                                                ['priority'] ==
                                            'Low'
                                        ? Colors.yellow
                                        : (RemindersList.allReminders[index]
                              ...
                              Padding(
                                ...
                                children:[
                                Text(
                                  RemindersList.allReminders[index]['title'],
                                  style: TextStyle(
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    RemindersList.allReminders[index]['date'] != ''
                                        ? (RemindersList.allReminders[index]
                                                    ['time'] !=
                                                ''
                                            ? '${RemindersList.allReminders[index]['date']}, ${RemindersList.allReminders[index]['time']} \n${RemindersList.allReminders[index]['notes']}'
                                            : '${RemindersList.allReminders[index]['date']}\n${RemindersList.allReminders[index]['notes']}')
                                        : '${RemindersList.allReminders[index]['notes']}',
                                    style: TextStyle(
                                        fontWeight: FontWeight.w500,

              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text('${context.watch<providerhomePage>().leghtAll}',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: ScreenUtil().setSp(37)),)
                  ],
                ),
                Expanded(
                  child: Align(
                      alignment: Alignment.bottomLeft,
                      child: Text('All',style: TextStyle(color: Colors.black45,fontSize: ScreenUtil().setSp(15),fontWeight: FontWeight.w700),)),
                )
              ],
            ),
          )

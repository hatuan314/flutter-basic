...
void main() {
  List<SinhVien> list_sv = new List(); // listSv
  ...
  while (true) {
    ...
    switch (choose) {
      ...
      case 3:
        {
          print('danh sach sv');
          for (SinhVien sv in list_sv) print(sv.toString());
          print('danh sach gv');
          for (GiangVien gv in list_gv) print(gv.toString());
          continue;
        }
      case 4:
        {
          for (GiangVien gv in list_gv) {
            ...
            for (SinhVien sv in list_sv) {
              if (gv.khoa == sv.nganhHoc) map_gv_sv[gv.hoTen].add(sv.hoTen);
            }
          }
          print(map_gv_sv);
          continue;
      ...
      case 5:
        {
          print('danh sach nu');
          for (SinhVien sv in list_sv)
            if (sv.gioiTinh == 'nu') print(sv.toString());
          for (GiangVien gv in list_gv)
            if (gv.gioiTinh == 'nu') print(gv.toString());
          continue;
        }
      case 6:
        {

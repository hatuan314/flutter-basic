// 1. Khởi tạo đối tượng phân số bao gồm 2 thuộc tính tử số và mẫu số. Sau đó thực hiện các chức năng sau:
// 1. Nhập vào từ bàn phím 1 phân số bất kì. Hiển thị phân số đó ra màn hình. INPUT: Tử số: 1 Mẫu số: 2 OUTPUT: 1/2

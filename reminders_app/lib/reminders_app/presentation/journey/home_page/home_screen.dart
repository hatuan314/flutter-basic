...
import 'package:reminders_app/reminders_app/presentation/journey/home_page/homepage_stream.dart';
import 'package:reminders_app/reminders_app/presentation/journey/list_screen/list/list_screen.dart';
        ...
        child: ListView(
          ...
          children: [
            ...
            GridView(
                ...
                children: [
                  StreamBuilder(
                    stream: homeStream.todayListLength,
                  ...
                  StreamBuilder(
                    stream: homeStream.scheduledListLength,
                    builder: (context, snapshot) => GestureDetector(
                      onTap: () async {
                        await Navigator.pushNamed(
            ...
            Padding(
              ...
              child: StreamBuilder(
                stream: homeStream.allListLength,
                builder: (context, snapshot) => GestureDetector(
                  onTap: () async {
            ...
            Padding(
              ...
              child: StreamBuilder( stream: homeStream.myLists,
                                ...
                                child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                          flex: 2,
                                          child: Text(
                                            '${snapshot.data[index].list.length}',

...
class _NewList extends State<NewList> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CreateListState>(
        initialData: CreateListState(listColor: Colors.blue, clearButton: false),
  ...
  {
    return  AppbarWidget(context,leadingText: 'Cancel',title: 'New List',
      onTapAction: GestureDetector(
        ...
        child: Container(
            ...
            child: Align(
              ...
              child: Text(
                  'Add',
                  style: ThemeText.actionButton.copyWith( color: createListState.clearButton ? Colors.blue : Colors.grey,)
              ),
            )
        ),
      ),

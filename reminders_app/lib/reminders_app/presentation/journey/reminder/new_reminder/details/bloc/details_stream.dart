...
class DetailsStream{
  ...
  bool hasDate=false;
  bool hasTime=false;
  DetailsState detailsState=DetailsState(date: 0,time:0,priority:0,hasDate: false,hasTime: false);
StreamController detailsController = StreamController<DetailsState>.broadcast();
  ...
  void setPriority(int value)
  {
    ...
    detailsController.sink.add(detailsState.update(date: date,time:time,priority:priority,hasDate: hasDate,hasTime: hasTime));
  }
